function Home() {
  ...
  <main className="l-main">
    ...
    <section className="home bd-grid" id="home">
      <div className="home__data">
        <h1 className="home__title">
          Hi,
          <br />
          I'am <span className="home__title-color">Vinay Kumar</span>
    ...
    <section className="about section " id="about">
      ...
      <div className="about__container bd-grid">
        ...
        <div>
          <h2 className="about__subtitle">I'am Vinay</h2>
    ...
    <section className="skills section" id="skills">
      ...
      <div className="skills__container bd-grid">
        <div>
          ...
          <div className="skills__data">
            <div className="skills__names">
              <i className="bx bxs-pain t skills__icon" />
  ...
  <footer className="footer">
    <p className="footer__title">Vinay Kumar</p>
    ...
    <p className="footer__copy">© VINAY KUMAR. All rigths reserved</p>
  </footer>
</>
